...
results_dir = f"{data_dir}/results/recreation/{dataset_name}_popLM_50"
...
for batch in tqdm(stimuli_loader):
    ...
    outs = [item for item in pop.call_function_with_population(transformer.model, population, lambda: call_me(premise, conclusion))]
